/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 2cc9bf15156fd29a8fdd4ec3fa19539a)
// Runtime types generated with workerd@1.20260424.1 2025-12-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		RUN_GMC_EMAIL_IDEMPOTENCY_KV: KVNamespace;
		RUN_GMC_X_CACHE_KV: KVNamespace;
		RUN_GMC_GENERIC_CACHE_KV: KVNamespace;
		CF_VERSION_METADATA: WorkerVersionMetadata;
		ENVIRONMENT: string;
		COVERFLEX_EMAIL: string;
		COVERFLEX_PASSWORD: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "COVERFLEX_EMAIL" | "COVERFLEX_PASSWORD" | "COVERFLEX_USER_AGENT_TOKEN" | "PRIVATE_BASIC_AUTH_USERNAME" | "PRIVATE_BASIC_AUTH_PASSWORD" | "ICLOUD_USER" | "ICLOUD_PASSWORD" | "X_BEARER" | "X_COOKIE" | "X_CSRF_TOKEN" | "DISCORD_AUTHORIZATION_TOKEN" | "SENTRY_DSN" | "DENO_PROXY_AUTH_TOKEN">> {}
}
