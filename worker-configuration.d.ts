/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 6258bfe3ae3e94d34aa0a18167696873)
// Runtime types generated with workerd@1.20260609.1 2025-12-23 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	POKE_API_KEY: string;
	HEALTHCHECK_DISCORD_SUCCEEDED_WEBHOOK_URL: string;
	HEALTHCHECK_DISCORD_FAILED_WEBHOOK_URL: string;
}
